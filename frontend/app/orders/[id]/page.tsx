        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {loading ? (
            <div className="space-y-6 animate-pulse">
              <div className="bg-white rounded-xl border border-gray-100 p-6 h-20" />
              <div className="bg-white rounded-xl border border-gray-100 p-6 h-64" />
            </div>
          ) : missing || !order ? (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
              <h2 className="text-xl font-semibold text-gray-900 mb-1">Order not found</h2>
              <p className="text-gray-500 text-sm mb-5">This order doesn&apos;t exist or you don&apos;t have access to it.</p>
              <Link href="/orders" className="px-5 py-2.5 bg-indigo-600 text-white rounded-lg text-sm font-semibold hover:bg-indigo-700 transition-colors">
                Back to Orders
              </Link>
            </div>
          ) : (
