        ...
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            {user?.role === 'admin' && (
              <Link
                href="/admin"
                className="hidden sm:inline-flex items-center gap-1 px-3 py-1.5 text-sm font-medium text-indigo-600 border border-indigo-200 rounded-lg hover:bg-indigo-50 transition-colors"
              >
...
export default function Navbar() {
  return (
    <Suspense fallback={
      <header className="bg-white border-b border-gray-100 sticky top-0 z-40 shadow-sm h-16" />
    }>
      <NavbarInner />
    </Suspense>
  );
